...
SHELLGET_INTEGER_LEFTX=$(check_value_integerbetweendefault "$SHELLGET_INTEGER_LEFTX" "$CONFIG_WMS_MINIMUMX" "$CONFIG_WMS_MAXIMUMX" "$CONFIG_WMS_DEFAULTLEFTX")
SHELLGET_INTEGER_TOPY=$(check_value_integerbetweendefault "$SHELLGET_INTEGER_TOPY" "$CONFIG_WMS_MINIMUMY" "$CONFIG_WMS_MAXIMUMY" "$CONFIG_WMS_DEFAULTTOPY")
SHELLGET_INTEGER_ZOOMLEVEL=$(check_value_integerbetweendefault "$SHELLGET_INTEGER_ZOOMLEVEL" "$CONFIG_WMS_ZOOMLEVELMINIMUM" "$CONFIG_WMS_ZOOMLEVELMAXIMUM" "$CONFIG_WMS_DEFAULTZOOMLEVEL")
