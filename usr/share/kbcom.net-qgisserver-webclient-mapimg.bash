...
then
 ...
 GLOBAL_BOOLEAN_CORRECTBBOX=$(check_value_integerbetween "$SHELLGET_INTEGER_BOTTOMY" "$CONFIG_WMS_MINIMUMY" "$CONFIG_WMS_MAXIMUMY")
fi

if [ "$GLOBAL_BOOLEAN_CORRECTBBOX" = true ]
then
 SHELLGET_INTEGER_LEFTX="$CONFIG_WMS_DEFAULTLEFTX"
 SHELLGET_INTEGER_BOTTOMY="$CONFIG_WMS_DEFAULTBOTTOMY"
 SHELLGET_INTEGER_ZOOMLEVEL="$CONFIG_WMS_DEFAULTZOOMLEVEL"
fi

#echo "---$SHELLGET_INTEGER_ZOOMLEVEL" "$SHELLGET_INTEGER_LEFTX" "$SHELLGET_INTEGER_BOTTOMY---"
GLOBAL_BBOX_MAPIMAGE=$(calculate_bbox "$SHELLGET_INTEGER_ZOOMLEVEL" "$SHELLGET_INTEGER_LEFTX" "$SHELLGET_INTEGER_BOTTOMY")
